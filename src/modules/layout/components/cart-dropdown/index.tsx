  ...
  return (
    <div className="h-full z-50" onMouseEnter={open} onMouseLeave={close}>
      <Popover className="relative h-full">
        <Popover.Button className="h-full flex items-center justify-center">
          <Link href="/cart">
            <div className="min-w-[100px] max-w-fit p-2 h-10  text-primary rounded-md flex items-center justify-center gap-2 hover:bg-gray-200">
              <HiOutlineShoppingBag className="text-xl" />
              <p className="font-semibold">
                Bag {totalItems ? `(${totalItems})` : null}
              </p>
            </div>
          </Link>
          {/* <Button
              ...
              <>
                ...
                <div className="p-4 flex flex-col gap-y-4 text-small-regular">
                  ...
                  <Link href="/cart" passHref>
                    <Button className="w-full">Go to bag</Button>
                  </Link>
                </div>
              </>
            ) : (
